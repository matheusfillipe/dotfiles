...
* **ZSH**: Stuff like ctrl+F to start a file search in the current path using refind, ctrl+O to lfcd, ctrl+E to inline edit shell with vim, intuitive vim mode, oh-my-zsh and many other keybindings and plugins and theme.
